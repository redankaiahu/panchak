...
def evaluate_buy_condition_1(historical_data, open_low_list, open_high_list,symbol,ORB15_IN_UP_SIDE,ORB15_IN_DOWN_SIDE,ORB15_IN_RANGE):
...
def main_loop():
    ...
    for symbol in symbols:
        historical_data = fetch_and_filter_symbol(symbol)
        if historical_data:
            evaluate_buy_condition_1(historical_data, open_low_list, open_high_list,symbol,ORB15_IN_UP_SIDE,ORB15_IN_DOWN_SIDE,ORB15_IN_RANGE)
