...
with tabs[5]:   # 👈 replace with correct index
    ...
    if _bias_col is None:
        ...
        _long_df = _long_df.sort_values("DIST_ENTRY_%", ascending=True).reset_index(drop=True)  # FIX-9c.reset_index(drop=True)  # FIX-9c.reset_index(drop=True)  # FIX-9c.reset_index(drop=True)  # FIX-9c.reset_index(drop=True)  # FIX-9c
        ...
        _short_df = _short_df.sort_values("DIST_ENTRY_%", ascending=False).reset_index(drop=True)  # FIX-9d.reset_index(drop=True)  # FIX-9d.reset_index(drop=True)  # FIX-9d.reset_index(drop=True)  # FIX-9d.reset_index(drop=True)  # FIX-9d
