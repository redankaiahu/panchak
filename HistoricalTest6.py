...
def evaluate_buy_condition_1(historical_data,symbol, buy_cond2_list,high_orbh15_list):
    ...
    if historical_data:
        ...
        ORBL15_Sell_diff = round(float(((ORBL15_one - yesterday_close) / ORBL15_one) * 100),2)
        ORBL15_Sell_diff1 = round(float(ORBL15_one - yesterday_close),2)

        ORBH15_buy_diff = round(float((( yesterday_close - ORBH15_one) / yesterday_close) * 100),2)
        ORBH15_buy_diff1 = round(float( yesterday_close - ORBH15_one),2)

        ORBH15_ORBL15_diff = round(float((( ORBH15_one - ORBL15_one)/ORBH15_one) * 100),2)
