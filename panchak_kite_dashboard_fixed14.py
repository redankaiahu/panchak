    ...
    if oi_intel is None:
        ...
        if _ce_bld and _pe_crm:
            ...
            pattern_detail = (
                ...
                f"writers covering shorts. Bullish signal if spot holds above {nearest_put_floor or s_pe}."
            )
            trade_bias = "BULLISH"
            ...
            pattern_detail = (
                ...
                f"support being withdrawn. Bearish signal if spot stays below {nearest_call_wall or s_ce}."
            )
            trade_bias = "BEARISH"
            ...
            pattern_detail = (
                ...
                f"PCR={pcr}. Nearest put floor: {nearest_put_floor or s_pe}."
            )
            trade_bias = "BEARISH"
            ...
            pattern_detail = (
                ...
                f"PCR={pcr}. Nearest call wall: {nearest_call_wall or s_ce}."
            )
            trade_bias = "BULLISH"
            ...
            pattern_detail = (
                ...
                f"Range: {nearest_put_floor or s_pe} – {nearest_call_wall or s_ce}."
            )
            trade_bias = "NEUTRAL"
        ...
        _ncw = nearest_call_wall if isinstance(nearest_call_wall, (int,float)) else (s_ce if s_ce > spot else atm + step)
        _npf = nearest_put_floor if isinstance(nearest_put_floor, (int,float)) else (s_pe if s_pe < spot else atm - step)
