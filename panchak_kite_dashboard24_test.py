...
ACCESS_TOKEN_FILE = "access_token_test.txt"
...
if not os.path.exists("access_token_test.txt"):
    st.error("❌ Access token not found. Use Control Panel.")
    st.stop()

with open("access_token_test.txt") as f:
...
with tabs[9]:  # assuming INFO is last tab
