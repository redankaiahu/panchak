...
def get_orders_file_path():
    today = datetime.now()
    file_name = today.strftime("june_orders_placed_%d-%m-%Y.pkl")
    return file_name
...
def evaluate_buy_condition_ORB60(data,ltp,open_price,high_price,low_price,volume, symbol_name, instrument, yesterday_open, yesterday_high, yesterday_low, yesterday_close, yesterday_vol, daybefore_open, daybefore_high, daybefore_low, daybefore_close, daybefore_vol, three_days_ago_open, three_days_ago_high, three_days_ago_low, three_days_ago_close, three_days_ago_vol,four_days_ago_open, four_days_ago_high, four_days_ago_low, four_days_ago_close, four_days_ago_vol, five_days_ago_close,Y_H_C_d,Y_H_L_d,Y_C_L_d,YHCon,YLCon,latest_max_5,latest_max_120,SMA_Volume_5, ema_200, ema_50, ema_20, ema_13,conditionB1,conditionB2,conditionB3,conditionB4,conditionI1,conditionI2,conditionSB,conditionS1,conditionS2,conditionS3,conditionS4,YCCon,weekly_open,weekly_high,weekly_low,weekly_close,low_values60,high_values60,high_values60Con,low_values60Con):
    try:
        if (
            ...
            open_price < data["yesterday_high"] and   #june 1
            open_price > data["yesterday_close"] - 0.01 * data["yesterday_close"] and
            data["yesterday_close"] > data["yesterday_open"] and
            ltp > data["yesterday_close"] and
            ltp > data["yesterday_high"] and 
            ltp > weekly_high and
...
def evaluate_buy_condition_ORB15(data,ltp,open_price,high_price,low_price,volume, symbol_name, instrument, yesterday_open, yesterday_high, yesterday_low, yesterday_close, yesterday_vol, daybefore_open, daybefore_high, daybefore_low, daybefore_close, daybefore_vol, three_days_ago_open, three_days_ago_high, three_days_ago_low, three_days_ago_close, three_days_ago_vol,four_days_ago_open, four_days_ago_high, four_days_ago_low, four_days_ago_close, four_days_ago_vol, five_days_ago_close,Y_H_C_d,Y_H_L_d,Y_C_L_d,YHCon,YLCon,latest_max_5,latest_max_120,SMA_Volume_5, ema_200, ema_50, ema_20, ema_13,conditionB1,conditionB2,conditionB3,conditionB4,conditionI1,conditionI2,conditionSB,conditionS1,conditionS2,conditionS3,conditionS4,YCCon,weekly_open,weekly_high,weekly_low,weekly_close,low_values60,high_values60,high_values60Con,low_values60Con):
    try:
        if (
            #Y_H_C_d < 1.5 and
            open_price > data["yesterday_close"] and  #june 1
            ...
            data["daybefore_high"] < data["yesterday_high"] and
            data["three_days_ago_high"] < data["yesterday_high"] and
            data["four_days_ago_high"] < data["yesterday_high"] and
            weekly_high < data["yesterday_high"] and
            ltp > weekly_high and
            ltp > open_price and
            ltp > high_values60  and 
            ltp < high_values60Con
        ):            
            place_order_with_prevention( instrument, TransactionType.Buy, ltp, symbol_name,open_price,high_price,low_price,volume,yesterday_open,yesterday_high,yesterday_low,yesterday_close,conditionB1, yesterday_vol,weekly_open,weekly_high,weekly_low,weekly_close,low_values60,high_values60 )
            #print("-> -> -> -> -> -> ->          evaluate_buy_condition_ORB60        -> -> -> -> -> -> -> -> -> -> -> -> ->-> -> -> -> -> -> -> ->-> -> -> -> -> -> -> ->")
            #print(f" {symbol_name}: high_values60: {high_values60}, low_values60: {low_values60}, day's Open: {open_price}, High: {high_price}, Low: {low_price}, LTP: {ltp},Volume:{volume} ")
            #print(f"Yesterday's Open: {yesterday_open}, High: {yesterday_high}, Low: {yesterday_low}, Close: {yesterday_close},yesterday_vol:{yesterday_vol}")
            #print(f"weekly_open: {weekly_open}, weekly_high: {weekly_high}, weekly_low: {weekly_low}, weekly_close: {weekly_close}")
        ...
        if instrument:
            ...
            if historical_data:
                ...
                if isinstance(historical_data_one, pd.DataFrame) and not historical_data_one.empty: 
                    low_values = historical_data_one.iloc[:15]['low'].tolist()   # 15 minutes usage
                    high_values = historical_data_one.iloc[:15]['high'].tolist()
                ...
                low_values60Con = low_values60 - (low_values60 * 0.0015)
                high_values60Con = high_values60 + (high_values60 * 0.0015)
            ...
            try:
                with ThreadPoolExecutor(max_workers=350) as executor:
                    ...
                    futures = [
                        ...
                        executor.submit(evaluate_buy_condition_ORB15,historical_data,ltp,open_price,high_price,low_price,volume, symbol_name, instrument, yesterday_open, yesterday_high, yesterday_low, yesterday_close, yesterday_vol, daybefore_open, daybefore_high, daybefore_low, daybefore_close, daybefore_vol, three_days_ago_open, three_days_ago_high, three_days_ago_low, three_days_ago_close, three_days_ago_vol,four_days_ago_open, four_days_ago_high, four_days_ago_low, four_days_ago_close, four_days_ago_vol, five_days_ago_close,Y_H_C_d,Y_H_L_d,Y_C_L_d,YHCon,YLCon,latest_max_5,latest_max_120,SMA_Volume_5, ema_200, ema_50, ema_20, ema_13,conditionB1,conditionB2,conditionB3,conditionB4,conditionI1,conditionI2,conditionSB,conditionS1,conditionS2,conditionS3,conditionS4,YCCon,weekly_open,weekly_high,weekly_low,weekly_close,low_values60,high_values60,high_values60Con,low_values60Con),
                        executor.submit(evaluate_buy_condition_ORB60,historical_data,ltp,open_price,high_price,low_price,volume, symbol_name, instrument, yesterday_open, yesterday_high, yesterday_low, yesterday_close, yesterday_vol, daybefore_open, daybefore_high, daybefore_low, daybefore_close, daybefore_vol, three_days_ago_open, three_days_ago_high, three_days_ago_low, three_days_ago_close, three_days_ago_vol,four_days_ago_open, four_days_ago_high, four_days_ago_low, four_days_ago_close, four_days_ago_vol, five_days_ago_close,Y_H_C_d,Y_H_L_d,Y_C_L_d,YHCon,YLCon,latest_max_5,latest_max_120,SMA_Volume_5, ema_200, ema_50, ema_20, ema_13,conditionB1,conditionB2,conditionB3,conditionB4,conditionI1,conditionI2,conditionSB,conditionS1,conditionS2,conditionS3,conditionS4,YCCon,weekly_open,weekly_high,weekly_low,weekly_close,low_values60,high_values60,high_values60Con,low_values60Con),
                        executor.submit(evaluate_Sell_condition_ORB60,historical_data,ltp,open_price,high_price,low_price,volume, symbol_name, instrument, yesterday_open, yesterday_high, yesterday_low, yesterday_close, yesterday_vol, daybefore_open, daybefore_high, daybefore_low, daybefore_close, daybefore_vol, three_days_ago_open, three_days_ago_high, three_days_ago_low, three_days_ago_close, three_days_ago_vol,four_days_ago_open, four_days_ago_high, four_days_ago_low, four_days_ago_close, four_days_ago_vol, five_days_ago_close,Y_H_C_d,Y_H_L_d,Y_C_L_d,YHCon,YLCon,latest_max_5,latest_max_120,SMA_Volume_5, ema_200, ema_50, ema_20, ema_13,conditionB1,conditionB2,conditionB3,conditionB4,conditionI1,conditionI2,conditionSB,conditionS1,conditionS2,conditionS3,conditionS4,YCCon,weekly_open,weekly_high,weekly_low,weekly_close,low_values60,high_values60,high_values60Con,low_values60Con)
...
def place_order_with_prevention( instrument, transaction_type, price,  symbol_name,open_price,high_price,low_price,volume,yesterday_open,yesterday_high,yesterday_low,yesterday_close,condition, yesterday_vol,weekly_open,weekly_high,weekly_low,weekly_close,low_values60,high_values60 ):   
    ...
    try:
        ...
        print(f"  high_values60: {high_values60}, low_values60: {low_values60},day's Open: {open_price}, High: {high_price}, Low: {low_price}, LTP: {ltp},Volume:{volume} ")
        print(f"Yesterday's Open: {yesterday_open}, High: {yesterday_high}, Low: {yesterday_low}, Close: {yesterday_close},yesterday_vol:{yesterday_vol}")
        print(f"weekly_open: {weekly_open}, weekly_high: {weekly_high}, weekly_low: {weekly_low}, weekly_close: {weekly_close}")
...
def should_place_order():
    current_time = datetime.now().time()
    cutoff_time_start = datetime.strptime('09:31:55', '%H:%M:%S').time()  # After 9:21 AM
        ...
        try:
            while not terminate_program:
                ...
                if not should_place_order():
                    print("It's NOT a Shopping zone before 09:31:55 AM and after 14:45 PM. Sleeping for 60 seconds.")
