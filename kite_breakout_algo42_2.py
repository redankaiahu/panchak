...
<div class="main">
  ...
  <div class="pane" id="pane-hs">
    <div class="heng-row">
      <button class="heng-btn hact" id="hE_A" onclick="setHEng('A')">Strategy A — Breakout</button>
    </div>
    <div class="hper-row">
...
def _build_history_payload(engine_key="A"):
    ...
    def do_GET(self):
        try:
            if self.path.startswith("/data"):
                ...
                import json as _hj
                body = _hj.dumps({"A": _build_history_payload("A")},
                                 default=str).encode()
                ct   = "application/json"
            else:
