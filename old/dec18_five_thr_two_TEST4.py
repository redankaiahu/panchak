    ...
    if feed_message.get("t") == "tk":  # Token data for OHLC
        ...
        if instrument:
            ...
            if historical_data:
                ...
                low_values, high_values, low_values15, high_values15 = None, None, None, None
                        ...
                        if not historical_data_one.empty:
                            ...
                            try:
                                ...
                                if len(historical_data_one) >= 15:
                                    ...
                                    print("Successfully extracted low and high values.")
                                    break  # Exit the loop if extraction is successful
                                else:
                                    print("Insufficient data for extracting low and high values")
                            except KeyError as e:
                                    print(f"KeyError: Missing column in historical_data_one - {e}")
                        else:
                            print("Websocket 15 minutes data is empty.")
                    except Exception as e:
                        print(f"An error occurred while fetching 15 minutes websocket data: {e}")
