        ...
        if MODE == "paper":
            ...
            try:
                ...
                if trade_data.get('buy_above'):
                    ...
                    stop_loss_price = float(limit_price - 3) , # trade_data.get('sl'),  #round_to_two_decimals(stop_loss_price_cal)
                    ...
                    target_price = trade_data.get('target'),    #round_to_two_decimals(target_price_cal)
