...
def fetch_and_filter_symbol(symbol):
    try:
        ...
        #print(f"Type of historical_data: {type(historical_data)}")
...
def evaluate_buy_condition_1(data, ltp,open_price,high_price,low_price,volume,ORBL5,ORBH5,ORBL15,ORBH15,condition1,condition2,condition3, condition4, condition5,ORBL15_one,ORBH15_one,ORBL15_two,ORBH15_two,ORBL15_thr,ORBH15_thr,ORBL15_four,ORBH15_four,ORBH5Con, ORBL5Con, ORBH15Con, ORBL15Con, ORBHP, ORBLP,SMA_5, ema_200, ema_50, ema_20, ema_13, symbol_name, instrument, yesterday_open, yesterday_high, yesterday_low, yesterday_close, yesterday_vol, daybefore_open, daybefore_high, daybefore_low, daybefore_close, daybefore_vol, three_days_ago_open, three_days_ago_high, three_days_ago_low, three_days_ago_close, three_days_ago_vol,four_days_ago_open, four_days_ago_high, four_days_ago_low, four_days_ago_close, four_days_ago_vol, five_days_ago_close,latest_max_5,latest_max_120,SMA_Volume_5,Y_H_C_d,Y_H_L_d,Y_C_L_d,ORBL15_S_d_p,ORBL15_S_d,ORBH15_B_d_p,ORBH15_B_d,ORBH15_ORBL15_d):
    try:
        if (
            ...
            print(f"Y_H_C_d: {Y_H_C_d}, Y_H_L_d: {Y_H_L_d}, Y_C_L_d: {Y_C_L_d}, ORBL15_S_d_p: {ORBL15_S_d_p}, ORBL15_S_d: {ORBL15_S_d}, ORBH15_B_d_p:{ORBH15_B_d_p},ORBH15_B_d: {ORBH15_B_d},ORBH15_ORBL15_d: {ORBH15_ORBL15_d}\n")
...
def Intraday_Magic(data, ltp,open_price,high_price,low_price,volume,ORBL5,ORBH5,ORBL15,ORBH15,condition1,condition2,condition3, condition4, condition5,ORBL15_one,ORBH15_one,ORBL15_two,ORBH15_two,ORBL15_thr,ORBH15_thr,ORBL15_four,ORBH15_four,ORBH5Con, ORBL5Con, ORBH15Con, ORBL15Con, ORBHP, ORBLP,SMA_5, ema_200, ema_50, ema_20, ema_13, symbol_name, instrument, yesterday_open, yesterday_high, yesterday_low, yesterday_close, yesterday_vol, daybefore_open, daybefore_high, daybefore_low, daybefore_close, daybefore_vol, three_days_ago_open, three_days_ago_high, three_days_ago_low, three_days_ago_close, three_days_ago_vol,four_days_ago_open, four_days_ago_high, four_days_ago_low, four_days_ago_close, four_days_ago_vol, five_days_ago_close,latest_max_5,latest_max_120,SMA_Volume_5,Y_H_C_d,Y_H_L_d,Y_C_L_d,ORBL15_S_d_p,ORBL15_S_d,ORBH15_B_d_p,ORBH15_B_d,ORBH15_ORBL15_d):
    try:
        if (
            ...
            ltp > open_price
            #open_price >  data["yesterday_close"] and
            #open_price >  data["yesterday_low"] 

         ):
            print(f"Intraday_Magic--{symbol_name}: day's Open: {open_price}, High: {high_price}, SMA_5:{SMA_5}, Low: {low_price}, LTP: {ltp}, ORBL5: {ORBL5}, ORBH5: {ORBH5}, ORBH15: {ORBH15}, ORBL15: {ORBL15}")
            print(f"Y_H_C_d: {Y_H_C_d}, Y_H_L_d: {Y_H_L_d}, Y_C_L_d: {Y_C_L_d}, ORBL15_S_d_p: {ORBL15_S_d_p}, ORBL15_S_d: {ORBL15_S_d}, ORBH15_B_d_p:{ORBH15_B_d_p},ORBH15_B_d: {ORBH15_B_d},ORBH15_ORBL15_d: {ORBH15_ORBL15_d}\n")
            #print(f"Y_Open: {data['yesterday_open']}, High: {data['yesterday_high']}, Low: {data['yesterday_low']}, Close: {data['yesterday_close']}, volume: {volume}, yesterday_vol:{data['yesterday_vol']}, daybefore_vol: {data['daybefore_vol']}\n")
...
def Shortterm_Breakout(data, ltp,open_price,high_price,low_price,volume,ORBL5,ORBH5,ORBL15,ORBH15,condition1,condition2,condition3, condition4, condition5,ORBL15_one,ORBH15_one,ORBL15_two,ORBH15_two,ORBL15_thr,ORBH15_thr,ORBL15_four,ORBH15_four,ORBH5Con, ORBL5Con, ORBH15Con, ORBL15Con, ORBHP, ORBLP,SMA_5, ema_200, ema_50, ema_20, ema_13, symbol_name, instrument, yesterday_open, yesterday_high, yesterday_low, yesterday_close, yesterday_vol, daybefore_open, daybefore_high, daybefore_low, daybefore_close, daybefore_vol, three_days_ago_open, three_days_ago_high, three_days_ago_low, three_days_ago_close, three_days_ago_vol,four_days_ago_open, four_days_ago_high, four_days_ago_low, four_days_ago_close, four_days_ago_vol, five_days_ago_close,latest_max_5,latest_max_120,SMA_Volume_5,Y_H_C_d,Y_H_L_d,Y_C_L_d,ORBL15_S_d_p,ORBL15_S_d,ORBH15_B_d_p,ORBH15_B_d,ORBH15_ORBL15_d):
    try:
        if (
            ...
            print(f"Shortterm_Breakout--{symbol_name}: day's Open: {open_price}, High: {high_price}, Low: {low_price}, LTP: {ltp}, ORBL5: {ORBL5}, ORBH5: {ORBH5}, ORBH15: {ORBH15}, ORBL15: {ORBL15}, latest_max_5: {latest_max_5}, latest_max_120: {latest_max_120}, SMA_Volume_5: {SMA_Volume_5}")
            print(f"Y_H_C_d: {Y_H_C_d}, Y_H_L_d: {Y_H_L_d}, Y_C_L_d: {Y_C_L_d}, ORBL15_S_d_p: {ORBL15_S_d_p}, ORBL15_S_d: {ORBL15_S_d}, ORBH15_B_d_p:{ORBH15_B_d_p},ORBH15_B_d: {ORBH15_B_d},ORBH15_ORBL15_d: {ORBH15_ORBL15_d}\n")
            #print(f"Y_Open: {data['yesterday_open']}, High: {data['yesterday_high']}, Low: {data['yesterday_low']}, Close: {data['yesterday_close']}, volume: {volume}, yesterday_vol:{data['yesterday_vol']}, daybefore_vol: {data['daybefore_vol']}\n")
...
def evaluate_sell_condition(data, ltp,open_price,high_price,low_price,volume,ORBL5,ORBH5,ORBL15,ORBH15,condition1,condition2,condition3, condition4, condition5,ORBL15_one,ORBH15_one,ORBL15_two,ORBH15_two,ORBL15_thr,ORBH15_thr,ORBL15_four,ORBH15_four,ORBH5Con, ORBL5Con, ORBH15Con, ORBL15Con, ORBHP, ORBLP,SMA_5, ema_200, ema_50, ema_20, ema_13, symbol_name, instrument, yesterday_open, yesterday_high, yesterday_low, yesterday_close, yesterday_vol, daybefore_open, daybefore_high, daybefore_low, daybefore_close, daybefore_vol, three_days_ago_open, three_days_ago_high, three_days_ago_low, three_days_ago_close, three_days_ago_vol,four_days_ago_open, four_days_ago_high, four_days_ago_low, four_days_ago_close, four_days_ago_vol, five_days_ago_close,latest_max_5,latest_max_120,SMA_Volume_5,Y_H_C_d,Y_H_L_d,Y_C_L_d,ORBL15_S_d_p,ORBL15_S_d,ORBH15_B_d_p,ORBH15_B_d,ORBH15_ORBL15_d):
    try:
        if (
            ...
            print(f"Sell--{symbol_name}: day's Open: {open_price}, High: {high_price}, Low: {low_price}, LTP: {ltp}, ORBL5: {ORBL5}, ORBH5: {ORBH5}, ORBH15: {ORBH15}, ORBL15: {ORBL15}")
            print(f"Y_H_C_d: {Y_H_C_d}, Y_H_L_d: {Y_H_L_d}, Y_C_L_d: {Y_C_L_d}, ORBL15_S_d_p: {ORBL15_S_d_p}, ORBL15_S_d: {ORBL15_S_d}, ORBH15_B_d_p:{ORBH15_B_d_p},ORBH15_B_d: {ORBH15_B_d},ORBH15_ORBL15_d: {ORBH15_ORBL15_d}\n")
            #print(f"Y_Open: {data['yesterday_open']}, High: {data['yesterday_high']}, Low: {data['yesterday_low']}, Close: {data['yesterday_close']}, volume: {volume}, yesterday_vol:{data['yesterday_vol']}, daybefore_vol: {data['daybefore_vol']}\n")
    ...
    if feed_message.get("t") == "tk":  # Token data for OHLC
        ...
        if instrument:
            ...
            if historical_data:
                ...
                Y_H_C_d = round(float(((yesterday_high - yesterday_close) / yesterday_high) * 100),2)
                Y_H_L_d = round(float(((yesterday_high - yesterday_low) / yesterday_high) * 100),2)
                Y_C_L_d = round(float(((yesterday_close - yesterday_low) / yesterday_close) * 100),2)
            ...
            #print(f"Type of historical_data_one: {type(historical_data_one)}")
            ...
            if isinstance(historical_data_one, pd.DataFrame) and not historical_data_one.empty:
                ...
                try:
                    ...
                    if 'EMA_200' in historical_data_one and not historical_data_one['EMA_200'].isna().all():
            ...
            ORBL15_S_d_p = round(float(((ORBL15 - ltp) / ORBL15) * 100),2)# caluculating percentage, when sell from ORBL15 to ltp
            ORBL15_S_d = round(float(ORBL15 - ltp),2)                        # caluculating in numbers , when sell from ORBL15 to ltp

            ORBH15_B_d_p = round(float((( ltp - ORBH15) / ltp) * 100),2) # caluculating percentage, when buy from ORBH15 to ltp
            ORBH15_B_d = round(float( ltp - ORBH15),2)                            # caluculating in numbers , when buy from ORBH15 to ltp

            ORBH15_ORBL15_d = round(float((( ORBH15 - ORBL15)/ORBH15) * 100),2) #  calculating ORBH15 and ORBL15 range in %
...
def should_place_order():
    ...
    # Define cutoff times
    cutoff_time_start = datetime.strptime('04:30:05', '%H:%M:%S').time()  # After 9:21 AM
