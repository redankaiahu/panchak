...
def evaluate_buy_condition_ORB15(data, ltp,open_price,high_price,low_price,volume,ORBL5,ORBH5,condition1,condition2,condition3, condition4, condition5,ORBL15_one,ORBH15_one,ORBL15_two,ORBH15_two,ORBL15_thr,ORBH15_thr,ORBL15_four,ORBH15_four,ORBH5Con, ORBL5Con, ORBH15Con, ORBL15Con, ORBHP, ORBLP,SMA_5):
    try:
        if (
...
# Evaluate sell condition
def evaluate_sell_condition_ORB15(data, ltp,open_price,high_price,low_price,volume,ORBL5,ORBH5,condition1,condition2,condition3, condition4, condition5,ORBL15_one,ORBH15_one,ORBL15_two,ORBH15_two,ORBL15_thr,ORBH15_thr,ORBL15_four,ORBH15_four,ORBH5Con, ORBL5Con, ORBH15Con, ORBL15Con, ORBHP, ORBLP,SMA_5):
    try:
        if (
    ...
    if feed_message.get("t") == "tk":  # Token data for OHLC
        ...
        if instrument:
            ...
            if evaluate_buy_condition_1(historical_data, ltp,open_price,high_price,low_price,volume,ORBL5,ORBH5, condition1, condition2, condition3, condition4, condition5,ORBL15_one,ORBH15_one,ORBL15_two,ORBH15_two,ORBL15_thr,ORBH15_thr,ORBL15_four,ORBH15_four,ORBH5Con, ORBL5Con, ORBH15Con, ORBL15Con, ORBHP, ORBLP,SMA_5):
                ...
                thread = threading.Thread(target=place_order_with_prevention, args=( instrument, TransactionType.Buy, ltp,  stop_loss, symbol_name, condition4,open_price,high_price,low_price,volume,ORBL5,ORBH5,yesterday_open,yesterday_high,yesterday_low,yesterday_close,ORBL15_one,ORBH15_one,ORBL15_two,ORBH15_two,ORBL15_thr,ORBH15_thr,ORBL15_four,ORBH15_four,ORBH5Con, ORBL5Con, ORBH15Con, ORBL15Con, ORBHP, ORBLP,SMA_5 ),daemon=True, name=evaluate_buy_condition_ORB15)
                thread.start()
                monitor_thread(thread)
            elif should_evaluate_condition() and evaluate_sell_condition_ORB15(historical_data, ltp,open_price,high_price,low_price,volume,ORBL5,ORBH5, condition1, condition2, condition3, condition4, condition5,ORBL15_one,ORBH15_one,ORBL15_two,ORBH15_two,ORBL15_thr,ORBH15_thr,ORBL15_four,ORBH15_four,ORBH5Con, ORBL5Con, ORBH15Con, ORBL15Con, ORBHP, ORBLP,SMA_5):
                ...
                thread = threading.Thread(target=place_order_with_prevention, args=(  instrument, TransactionType.Sell, ltp,  stop_loss, symbol_name, condition5,open_price,high_price,low_price,volume,ORBL5,ORBH5,yesterday_open,yesterday_high,yesterday_low,yesterday_close,ORBL15_one,ORBH15_one,ORBL15_two,ORBH15_two,ORBL15_thr,ORBH15_thr,ORBL15_four,ORBH15_four,ORBH5Con, ORBL5Con, ORBH15Con, ORBL15Con, ORBHP, ORBLP,SMA_5 ),daemon=True, name=evaluate_sell_condition_ORB15)
                thread.start()
                monitor_thread(thread)
       # while True:
...
def monitor_thread(thread):
    ...
    while thread.is_alive():
        print(f"{ConsoleColors.WARNING}Thread {thread.name} is running...{ConsoleColors.ENDC}- TIME: {current_time1}")
