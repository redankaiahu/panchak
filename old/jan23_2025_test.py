...
def modify_stoploss_orders_data(symbol, ltp1, stoploss_price, target_price, trigger_price,executed_price, trantype, sl_order_id, qty ):
    ...
    try:
        ...
        TICK_SIZE = 0.05
        new_stop_loss = float(round_to_tick(new_stop_loss, TICK_SIZE))
        new_trigger_price = float(round_to_tick(new_trigger_price, TICK_SIZE))
        ...
        try:
            ...
            print(f"======>> SL order modified successfully for {symbol} at {new_stop_loss} and executed price is: {executed_price} : {modify_order_response}\n")
        except Exception as e:
