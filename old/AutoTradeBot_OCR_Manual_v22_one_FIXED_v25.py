        ...
        if MODE == "paper":
            ...
            try:
                ...
                if trade_data.get('buy_above'):
                    ...
                    stop_loss_price = round_to_tick(entry_price * 0.90)  # 0.90 is for 10%
                    trigger_price = round_to_tick(stop_loss_price + 0.30)
                    ...
                    TICK_SIZE = 0.05
                    entry_price = trade_data['entry']
                    stop_loss_price = round_to_tick(entry_price * 0.90)
                    trigger_price = round_to_tick(stop_loss_price + 0.30)
