...
# AutoTradeBot_OCR_Manual_Combined_Complete.py
# ✅ Supports OCR (image) + Manual (text) trade signals
# ✅ Places orders via Alice Blue API
# ✅ Switches to MARKET if LIMIT not filled
# ✅ Avoids duplicate trades
# ✅ Logs and alerts every step
