...
def modify_stoploss_orders_data(symbol, stoploss_price, target_price, trigger_price, executed_price, trantype):
    print(f"Symbol: {symbol},trantype:{trantype},executed_price:{executed_price},target:{target_price},stoploss:{stoploss_price},trigger:{trigger_price}\n")
