...
def evaluate_buy_condition_1(historical_data,symbol, buy_cond2_list,high_orbh15_list):
    ...
    if historical_data:
        ...
        if yesterday_open > daybefore_close and yesterday_open < daybefore_high and  daybefore_close > daybefore_open and yesterday_high > ORBH15_one and yesterday_close <  ORBH15_one:
        ...
        if  yesterday_open > daybefore_close and yesterday_open < daybefore_high and  daybefore_close > daybefore_open and yesterday_low < ORBL15_one and yesterday_close >  ORBL15_one:
