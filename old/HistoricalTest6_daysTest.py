...
def evaluate_buy_condition_1(historical_data,symbol, buy_cond2_list,high_orbh15_list):
    ...
    if historical_data:
        ...
        if  (
            ...
            yesterday_open < daybefore_high and
            daybefore_close > daybefore_open and
            daybefore_close > daybefore_open and
            three_days_ago_close < four_days_ago_close and            
            daybefore_vol > 300000 and
            #ltp < ORBL15Con and
            #yesterday_close > ORBH15_one  and 
            yesterday_close > ema_200 and
            yesterday_close > ema_50 
            #yesterday_close > ema_20 and
            #ltp > ema_13 and 
            #ema_13 > ema_20 and 
            #ema_20 > ema_50 and
            #ema_50 > ema_200  
        ...
        if (
            ...
            yesterday_open == yesterday_high and
            #ltp > ORBL5Con and
            yesterday_close < ema_200 and
            yesterday_close < ema_50 and
            yesterday_close < ema_20 and
            #yesterday_close < data["ema_13"] and
            ema_20 < ema_50 and
            ema_50 < ema_200 and
            daybefore_vol > 300000 and
            daybefore_low < three_days_ago_low 
            #ltp > ORBL15Con and
            #yesterday_close < ORBL15_one   #data["yesterday_low"]
            ...
            daybefore_close <= daybefore_open and
            daybefore_vol > 300000 
            #ltp > ORBL15Con and
            #yesterday_close < ORBL15_one   
            
        ) or (

            yesterday_open > daybefore_open and
            yesterday_open < daybefore_high and
            daybefore_close < daybefore_open and
            ...
            high_orbh15_list.append({
                ...
                "high_close_diff": high_close_diff,
                "high_low_diff": high_low_diff,
                "ORBL15_Sell_diff1": ORBL15_Sell_diff1,
                "ORBL15_Sell_diff": ORBL15_Sell_diff,
                "ORBH15_ORBL15_diff": ORBH15_ORBL15_diff
...
def main_loop():
    ...
    for symbol in symbols:
        historical_data = fetch_and_filter_symbol(symbol)
        if historical_data:
            evaluate_buy_condition_1(historical_data,symbol, buy_cond2_list,high_orbh15_list)
