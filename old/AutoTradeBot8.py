...
def place_trade(trade_data):
    try:
        ...
        if MODE == "paper":
            ...
            # ✅ LIVE ORDER PLACEMENT TO ALICEBLUE
            try:
                full_symbol = f"{trade_data['symbol']}{trade_data['strike']}{trade_data['option_type']}"  # Example HEROMOTO3700CE
                ...
                order = alice.place_order(
                    ...
                    quantity=trade_data.get("quantity", 25),  # Example default qty 25 (you can calculate lot size separately)
