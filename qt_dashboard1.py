...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("📈  Panchak Trading Dashboard  — Phase 2")
        ...
        self.tabs.addTab(self.bos_panel,   "📐  BOS Scanner")
        self.tabs.addTab(self.astro_panel, "🌙  Astro")
        self.tabs.addTab(self.time_panel,  "⏰  Time Signal")
        self.tabs.addTab(self.db_panel,    "📦  DB Status")
        ...
        self.statusBar().showMessage(
            "Phase 2 — OI Intelligence | SMC + OI | BOS Scanner | Astro | Time | DB | Session")
    ...
    def _auto_refresh(self):
        self.oi_panel.trigger_refresh()
        self.statusBar().showMessage(f"Auto-refreshed at {datetime.now().strftime('%H:%M:%S')}")
