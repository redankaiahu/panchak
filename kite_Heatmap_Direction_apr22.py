...
PROFIT_LOCK_TRIGGER  = 3000     # ₹ — arm the profit lock above this total PnL
PROFIT_LOCK_FLOOR    = 1500     # ₹ — minimum profit to preserve once locked (₹1 500 guaranteed)
HARD_LOSS_LIMIT      = -1800    # ₹ — square off ALL positions + halt when total PnL hits this
