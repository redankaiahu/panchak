...
FUTURES_LIST = [
    "NSE:RELIANCE26FEBFUT",
    "NSE:RELIANCE26MARFUT",
    "NSE:INFY26FEBFUT",
    "NSE:INFY26MARFUT",
    "NSE:HCLTECH26FEBFUT",
    "NSE:HCLTECH26MARFUT",
    "NSE:NIFTY26FEBFUT",
    "NSE:NIFTY26MARFUT",
    "NSE:BANKNIFTY26FEBFUT",
    "NSE:BANKNIFTY26MARFUT",
]
...
def fetch_futures_data():
    ...
    for sym in FUTURES_LIST:
        ...
        price_change = ((ltp - prev_close) / prev_close) * 100 if prev_close else 0
        ...
        oi_change_pct = 0
        if oi_day_low:
            oi_change_pct = ((oi - oi_day_low) / oi_day_low) * 100

        rows.append({
            "FUT_SYMBOL": sym.replace("NSE:",""),
            "LTP": round(ltp,2),
            "PRICE_%": round(price_change,2),
            "OI": oi,
            "OI_%": round(oi_change_pct,2)
        })
