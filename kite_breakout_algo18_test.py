...
def strategy(token, tick):
    ...
    vol_percent = 0
    if yest_volume > 0:
        vol_percent = round((live_volume / yest_volume) * 100, 2)

    change_percent = ((ltp - yest_close) / yest_close) * 100
    gap_percent = ((live_open - yest_close) / yest_close) * 100
    ...
    if (
        ...
        #place_trade(symbol, "BUY", ltp, tick, "ORB 1Hr Break")
        extra = {
            "orb_high": orb_high,
            "orb_low": orb_low,
            "f_high": f_high,
        ...
        place_trade(symbol, "BUY", ltp, tick, "ORB 1Hr Break", extra)
    ...
    if (
        ...
        f_high = first15_data.get(symbol, {}).get("high", 0)
        f_low = first15_data.get(symbol, {}).get("low", 0)
        #place_trade(symbol, "SELL", ltp, tick, "ORB 1 Hr Breakdown")
        extra = {
            "orb_high": orb_high,
            "orb_low": orb_low,
            "f_high": f_high,
        ...
        place_trade(symbol, "SELL", ltp, tick, "ORB 1Hr Breakdown", extra)
    ...
    if (
        ...
        place_trade(symbol, "BUY", ltp, tick, "OPEN==LOW BREAK", extra)
    ...
    if (
        ...
        place_trade(symbol, "SELL", ltp, tick, "OPEN==HIGH BREAK ", extra)
    ...
    if (
        ...
        place_trade(symbol, "BUY", ltp, tick, "YH Break", extra)
    ...
    if (
        ...
        place_trade(symbol, "SELL", ltp, tick, "YL Break", extra)

    # ==========================================================
    # ===== TEST STRATEGY 3: EXISTING YESTERDAY BREAKOUT ===========
    # ==========================================================
    ...
    if (
        ...
        place_trade(symbol, "BUY", ltp, tick, "YH Break TEST", extra)
...
if __name__ == "__main__":
    ...
    if TRADING_MODE == "PAPER" and input("Replay Mode? (y/n): ") == "y":
        ...
        # Load Yesterday & EMA for Live Mode
