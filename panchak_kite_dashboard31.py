...
for sym in SYMBOLS:
    ...
    ltp = live_map[sym]["LTP"]
    day_high = live_map[sym]["LIVE_HIGH"]
    day_low = live_map[sym]["LIVE_LOW"]
    yest_high = live_map[sym]["YEST_HIGH"]
    yest_low = live_map[sym]["YEST_LOW"]
    change = live_map[sym]["CHANGE"]
    change_pct = live_map[sym]["CHANGE_%"]
