# pip install requests pyotp pycryptodome
...
password = "RAJ!@34kane"
twofa= "1985"
#totp_encrypt_key="CIPJFGUQQQQVNLTTIOPOBYZNWCRPZXRO"
totp_encrypt_key="KAQUGJSPBFIFCVPZMHOTOELRJSOTPKCE"
...
#else:
 #   print("Login Failed: Response does not contain 'userSessionID'")

  if "userSessionID" in response_json: #if response.json()["userSessionID"]:
    print("Login Successfully")
else:
