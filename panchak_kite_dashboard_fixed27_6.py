...
def _style_gain(val):
    try:
        v = float(val)
        if v > 0: return "background-color:#003300;color:#00ff88;font-weight:700"
        if v < 0: return "background-color:#330000;color:#ff4466;font-weight:700"
    except Exception: pass
    return ""
...
def _style_change(val):
    try:
        v = float(val)
        if v > 0: return "background-color:#003300;color:#00ff88;font-weight:600"
        if v < 0: return "background-color:#330000;color:#ff4466;font-weight:600"
    except Exception: pass
    return ""
...
def _apply_fmt(df, row_style_fn=None):
    ...
    gain_cols   = [c for c in df.columns if c == "GAIN"]
    change_cols = [c for c in df.columns if c in ("CHANGE","CHANGE_%")]
